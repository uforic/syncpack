...
exports.run = function (program) { return __awaiter(_this, void 0, void 0, function () {
    var pkgs, dependencyTypes, indent, mismatchedVersionsByName;
        ...
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, Promise.all(pkgs.map(function (_a) {
                        ...
                        var changes = [];
                        Object.entries(mismatchedVersionsByName).forEach(function (_a) {
                            var name = _a[0], versions = _a[1];
                            var newest = version_1.getNewest(versions);
                        ...
                        if (changes.length > 0) {
                            changes.forEach(function (_a) {
                                var name = _a[0], from = _a[1], to = _a[2];
                                console.log(chalk_1["default"].bgYellow.black(' FIXED '), chalk_1["default"].blue(shortPath), name, chalk_1["default"].red(from), '→', chalk_1["default"].green(to));
                            });
